...
//       {userData && (
//         <div className="mb-8 rounded-lg border border-neutral-200 dark:border-neutral-700 shadow-sm p-6 bg-neutral-100 dark:bg-neutral-800/5">
...
//               <p className="text-neutral-600 font-mono dark:text-neutral-400">
//                 @{userData.login}
//               </p>
...
//           <div className="grid max-w-6xl grid-cols-1 overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:px-1 [&>*]:py-4 [&>*]:before:absolute [&>*]:before:bg-[#e5e7eb]/70 [&>*]:before:dark:border-neutral-700  [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-[#e5e7eb]/70 [&>*]:after:dark:border-neutral-700  [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] sm:[&>*]:px-8 xl:[&>*]:px-12">
